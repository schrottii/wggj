...
class WGGJ_Container {
    ...
    onHold(c, e) {
        ...
        if (this.XScroll == true) this.scrolledX += (e.clientX - this.recentMouseX) * this.XScrollMod;
        if (this.YScroll == true) this.scrolledY += (e.clientY - this.recentMouseY) * this.YScrollMod;
